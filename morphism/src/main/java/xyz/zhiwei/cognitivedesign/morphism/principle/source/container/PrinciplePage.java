 ...
 * @param <E>
 */
public class PrinciplePage<P extends Principle<?>> extends ArrayList<P>{
	...
	public PrinciplePage(){}

	public PrinciplePage(List<P> list){
	...
	public PrinciplePage(List<P> list,Long total){
		if(null!=list && list.size()>0) {
			list.stream().forEach(e-> add(e));
		}
		this.total=total;
