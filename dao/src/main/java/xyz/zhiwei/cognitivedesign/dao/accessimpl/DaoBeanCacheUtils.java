...
class DaoBeanCacheUtils {
     ...
     */
    static Class<?> resolveGenericEntityClass(Class<?> daoImplClass, Class<?> daoInterface) {
        // 空值防护
     ...
     */
    private static Class<?> extractRawClassFromType(Type type) {
